...
臺灣科技大學桌上遊戲研究社專用的線上抽獎工具，解決傳統抽獎輪盤重複抽取、有限制名單人數等問題。
...
「臺科桌遊社抽獎系統」是一套專為臺灣科技大學桌上遊戲研究社（BGC）社團活動打造的網頁抽獎工具。
...
> 📝 TODO：若有更詳細的操作流程（例如各按鈕功能、名單輸入格式），請於此補充完整說明。

---

## ⚙️ Configuration

> 📝 TODO：若專案有可調整的設定項目（例如抽獎人數上限、名單來源等），請於此補充。
